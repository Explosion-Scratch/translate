...
* @param {Object} opts The options, these can include "text", "from" and "to".
* @returns {Promise.<string>} Returns a promise that is resolved by the translated version.
*/
function translate(text, token, opts) {
  opts = {
    to: "en",
    text,
    ...opts,
...
* @param {Object} storage An optional object to store the key in. Pass an object such as this: {get: (item) => 'return this', set: (item, value) => 'set an item to a value'} Defaults to localStorage methods.
