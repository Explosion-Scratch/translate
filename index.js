...
* @param {Object} [opts={to: 'en', from: 'en'}] The options, these can include "text", "from" and "to".
...
function translate(text, opts, token) {
  ...
  opts = {
    to: "en",
    from: "en",
    cors: 'https://cors.explosionscratc.repl.co/',
    text,
    ...opts,
  };
  var data = {
  ...
  fetch(
    `${opts.cors}translate.google.com/translate_a/t?${query.toString()}`, {
      headers: {
